/**
 * SunsetTourHeroSSR - Server Component for SEO
 *
 * Renders the hero section with H1, subtitle, badges server-side for SEO.
...
export interface SunsetTourHeroTexts {
  badge: string;
  title: string;
  subtitle: string;
...
interface SunsetTourHeroSSRProps {
  texts: SunsetTourHeroTexts;
}

const SunsetTourHeroSSR = ({ texts }: SunsetTourHeroSSRProps) => {
  return (
...
export default SunsetTourHeroSSR;
