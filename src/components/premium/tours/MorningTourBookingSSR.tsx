/**
 * MorningTourBookingSSR - Server Component for SEO
 *
...
export interface MorningTourBookingTexts {
  sectionLabel: string;
  sectionTitle: string;
...
interface MorningTourBookingSSRProps {
  texts: MorningTourBookingTexts;
}

const MorningTourBookingSSR = ({ texts }: MorningTourBookingSSRProps) => {
  return (
            ...
            <div className="booking-detail-card">
              ...
              <div className="detail-content">
                ...
                <div style={{ fontSize: '0.85rem', color: '#64748b', marginTop: '8px', lineHeight: '1.6' }}>
                  <div>{texts.adults} {texts.adultsAge}: €68</div>
                  <div>{texts.children} {texts.childrenAge}: €48</div>
...
export default MorningTourBookingSSR;
