/**
 * SunsetTourGallerySSR - Server Component for SEO
 *
...
interface SunsetTourGallerySSRProps {
  texts: SunsetTourGalleryTexts;
}

const SunsetTourGallerySSR = ({ texts }: SunsetTourGallerySSRProps) => {
  return (
...
export default SunsetTourGallerySSR;
