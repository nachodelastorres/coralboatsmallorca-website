/**
 * MorningTourItinerarySSR - Server Component for SEO
 *
 * Renders the itinerary timeline server-side with correct language.
 * AOS animations still work via CSS classes.
 *
...
export interface MorningTourItineraryTexts {
  sectionLabel: string;
  sectionTitle: string;
...
interface MorningTourItinerarySSRProps {
  texts: MorningTourItineraryTexts;
}

const MorningTourItinerarySSR = ({ texts }: MorningTourItinerarySSRProps) => {
  return (
...
export default MorningTourItinerarySSR;
