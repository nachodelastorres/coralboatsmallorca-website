...
const SunsetTourGallery = () => {
  ...
  const images = [
    ...
    {
      src: '/assets/img/premium/sunset_new/guests-toasting-sunset-boat-tour-mallorca.webp',
    ...
    {
      src: '/assets/img/premium/sunset_new/sunset-boat-cruise-reddish-sky-alcudia.webp',
