...
export interface ContactFormClientTexts {
  nameLabel: string;
  surnameLabel: string;
  emailLabel: string;
  phoneLabel: string;
...
interface ContactFormClientProps {
  texts: ContactFormClientTexts;
}

const ContactFormClient = ({ texts }: ContactFormClientProps) => {
  const schema = useMemo(() => yup.object().shape({
    firstName: yup.string().required(texts.errorFirstName),
    lastName: yup.string().required(texts.errorLastName),
    email: yup
      .string()
      .email(texts.errorEmailInvalid)
      .required(texts.errorEmail),
    phone: yup.string().required(texts.errorPhone),
    subject: yup.string().required(texts.errorSubject),
    message: yup
      .string()
      .min(5, texts.errorMessageMin)
      .required(texts.errorMessage),
  }), [texts]);
      ...
      <div className="row g-4">
        ...
        <div className="col-sm-6">
          <div>
            ...
            <input
              type="text"
              placeholder={texts.surnameLabel}
              {...register('lastName')}
              style={{
                width: '100%',
                padding: '14px 18px',
        ...
        <div className="col-12">
          <div>
            ...
            <input
              type="text"
              placeholder={texts.subjectLabel}
              {...register('subject')}
              style={{
                width: '100%',
                padding: '14px 18px',
