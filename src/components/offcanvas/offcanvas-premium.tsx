...
const languageOptions: LanguageOptions = {
  ...
  ca: { label: 'Català', flag: '/flags/catalonia-modified.png' },
...
const OffCanvasPremium = ({
  ...
  const menuItems = [
    ...
    { id: 'about', label: t('menu.about'), href: getPath('/about'), icon: 'fa-anchor' },
    {
      ...
      icon: 'fa-ship',
      submenu: [
        { label: t('menu.morningTour'), href: getPath('/alcudia-morning-boat-tour'), icon: 'fa-sun' },
        { label: t('menu.sunsetTour'), href: getPath('/alcudia-sunset-boat-tour'), icon: 'fa-sunset' },
        { label: t('menu.privateTour'), href: getPath('/alcudia-private-boat-charter'), icon: 'fa-champagne-glasses' },
        { label: t('menu.allTours'), href: getPath('/boat-tours-alcudia'), icon: 'fa-compass' },
      ],
    },
    { id: 'gallery', label: t('menu.gallery'), href: getPath('/gallery'), icon: 'fa-camera' },
    { id: 'blog', label: t('menu.blog'), href: getPath('/blog'), icon: 'fa-newspaper' },
    { id: 'contact', label: t('menu.contact'), href: getPath('/contact'), icon: 'fa-envelope' },
  ];
  ...
  return (
    <>
      {/* Offcanvas */}
      <div className={`premium-offcanvas ${isOffCanvasOpen ? 'active' : ''}`}>
        <div className="premium-offcanvas__content">
          {/* Header */}
          <div className="premium-offcanvas__header">
            <Link href={getPath('/')} onClick={handleClose}>
          ...
          <div className="premium-offcanvas__contact">
            <h4 className="contact-title">{t('menu.getInTouch')}</h4>
            ...
            <a href="mailto:info@coralboatsmallorca.com" className="contact-item">
              ...
              <div className="contact-details">
                <span className="contact-label">{t('menu.email')}</span>
            ...
            <a href="https://wa.me/34651992329" target="_blank" rel="noopener noreferrer" className="contact-item">
              ...
              <div className="contact-details">
                <span className="contact-label">{t('menu.whatsapp')}</span>
          ...
          <div className="premium-offcanvas__cta">
            <Link href={getPath('/boat-tours-alcudia')} className="cta-button" onClick={handleClose}>
              <i className="fa-solid fa-calendar-check"></i>
              <span>{t('menu.bookYourTour')}</span>
            </Link>
          </div>

          {/* Social Links */}
          <div className="premium-offcanvas__social">
            <a href="https://www.facebook.com/coralboatsmallorca" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a href="https://www.google.com/search?q=coral+boats+mallorca" target="_blank" rel="noopener noreferrer" aria-label="Google">
      ...
      {/* Overlay */}
      <div
        className={`premium-offcanvas__overlay ${isOffCanvasOpen ? 'active' : ''}`}
        onClick={handleClose}
      ></div>
      ...
      <style jsx global>{`
        ...
        .premium-offcanvas__close:active {
        ...
        .contact-icon {
          ...
          font-size: 1.1rem;
          flex-shrink: 0;
          box-shadow: 0 4px 12px rgba(8, 145, 178, 0.4), inset 0 -2px 4px rgba(0, 0, 0, 0.2);
          transition: all 0.3s ease;
        }

        .contact-icon:hover {
          transform: scale(1.05);
          box-shadow: 0 6px 16px rgba(8, 145, 178, 0.5), inset 0 -2px 4px rgba(0, 0, 0, 0.2);
        }

        .contact-icon--whatsapp {
          background: linear-gradient(135deg, #25D366, #128C7E);
          box-shadow: 0 4px 12px rgba(37, 211, 102, 0.4), inset 0 -2px 4px rgba(0, 0, 0, 0.2);
        }

        .contact-icon--whatsapp:hover {
          box-shadow: 0 6px 16px rgba(37, 211, 102, 0.5), inset 0 -2px 4px rgba(0, 0, 0, 0.2);
        }
        ...
        .cta-button {
          ...
          cursor: pointer;
          transition: all 0.3s ease;
          box-shadow: 0 4px 15px rgba(8, 145, 178, 0.4), inset 0 -3px 6px rgba(0, 0, 0, 0.2), inset 0 2px 4px rgba(255, 255, 255, 0.2);
          position: relative;
          overflow: hidden;
        }
        ...
        .cta-button:hover {
          ...
          box-shadow: 0 6px 20px rgba(8, 145, 178, 0.6), inset 0 -3px 6px rgba(0, 0, 0, 0.2), inset 0 2px 4px rgba(255, 255, 255, 0.2);
        }

        .cta-button:active {
          transform: translateY(0);
          box-shadow: 0 2px 10px rgba(8, 145, 178, 0.4), inset 0 -2px 4px rgba(0, 0, 0, 0.2), inset 0 1px 2px rgba(255, 255, 255, 0.2);
        }
        ...
        .premium-offcanvas__social a:active {
...
export default OffCanvasPremium;
